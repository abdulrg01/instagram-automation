...
import { useCreateCampaignMutation } from "@/lib/redux/services/campaign";
...
export function CreateCampaignModal({
  ...
  const [createCampaign, { isLoading, isSuccess }] =
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Set up a new marketing campaign with automations and content
          </DialogDescription>
        </DialogHeader>
