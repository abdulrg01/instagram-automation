...
const campaigns = [
  {
    ...
    automations: [
      { _id: "auto_1", name: "Product Inquiry Bot", type: "Comment Reply", status: "active" },
      { _id: "auto_2", name: "Welcome New Followers", type: "DM Automation", status: "active" },
      { _id: "auto_3", name: "Size Guide Helper", type: "Comment Reply", status: "active" },
    ],
    posts: [
      { _id: "post_1", title: "Summer Dress Collection", type: "Feed Post", engagement: 1200 },
      { _id: "post_2", title: "Beach Accessories", type: "Story", engagement: 800 },
      { _id: "post_3", title: "Style Guide Video", type: "Reel", engagement: 2400 },
    ],
  },
  {
    _id: "camp_2",
    ...
    automations: [
      { _id: "auto_4", name: "FAQ Responder", type: "Comment Reply", status: "active" },
      { _id: "auto_5", name: "Support Ticket Creator", type: "DM Automation", status: "active" },
    ],
    posts: [
      { _id: "post_4", title: "How to Contact Us", type: "Feed Post", engagement: 600 },
      { _id: "post_5", title: "FAQ Highlights", type: "Story", engagement: 400 },
    ],
  },
  {
    _id: "camp_3",
    ...
    automations: [
      { _id: "auto_6", name: "Sale Announcer", type: "Comment Reply", status: "draft" },
      { _id: "auto_7", name: "Discount Code Sender", type: "DM Automation", status: "draft" },
    ],
    posts: [
      { _id: "post_6", title: "Black Friday Preview", type: "Feed Post", engagement: 0 },
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-800">
                    {campaigns.reduce((sum, c) => sum + c.automations.length, 0)}
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-blue-800">
                    {campaigns.reduce((sum, c) => sum + c.posts.length, 0)}
                  </p>
                </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="text-center p-3 bg-blue-50 rounded-lg">
                    <div className="text-lg font-bold text-blue-800">{campaign.posts.length}</div>
          ...
          <Card className="border-0 shadow-lg">
            ...
            <CardContent className="space-y-3">
              {selectedCampaign.posts.map((post) => (
                <div key={post._id} className="flex items-center justify-between p-3 border rounded-lg hover:bg-gray-50">
                  <div className="flex items-center space-x-3">
