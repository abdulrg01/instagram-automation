...
export default function FooterSection() {
  return (
    <footer className="border-b pt-20 bg-[#06007a]">
        ...
        <div className="mx-auto flex max-w-5xl flex-wrap items-end justify-between gap-6 px-6 pb-6">
          ...
          <div className="flex flex-wrap justify-center gap-6 text-sm">
            <Link
              ...
              className="text-white hover:text-muted-foreground block bg-[#035e85] p-2 rounded-full"
            >
              <svg
                className="size-6"
                xmlns="http://www.w3.org/2000/svg"
          ...
          <form className="row-start-1 border-b pb-8 text-sm md:col-span-2 md:border-none lg:col-span-1">
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                ...
                />
                <Button size="sm" className="bg-[#035e85] text-white">Submit</Button>
              </div>
